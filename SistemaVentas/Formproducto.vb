Public Class Formproducto
        ...
        If (txtnombre.Text <> String.Empty And txtprecio.Text <> String.Empty And txtstock.Value <> 0 And cbcategoria.Text <> String.Empty) Then
            ...
            Try
                If (txtcodigo.Text <> String.Empty) Then
                    ...
                    If (fp.edita_producto(txtcodigo.Text, txtnombre.Text, txtestado.Text, txtcrea.Text, txtmodifica.Text, txtprecio.Text, txtstock.Value, cbcategoria.SelectedValue) = True) Then
                ...
                Else
                    ...
                    If (fp.ingresa_producto(txtcodigo.Text, txtnombre.Text, txtprecio.Text, txtstock.Value, txtestado.Text, txtcrea.Text, txtmodifica.Text, cbcategoria.SelectedValue) = True) Then
    ...
    Private Sub dgvproucto_DoubleClick(sender As Object, e As EventArgs) Handles dgvproucto.DoubleClick
        ...
        txtstock.Text = dgvproucto.CurrentRow.Cells("stock").Value
        cbcategoria.Text = dgvproucto.CurrentRow.Cells("cod_categoria").Value
        txtestado.Text = dgvproucto.CurrentRow.Cells("estado").Value
        txtmodifica.Text = dgvproucto.CurrentRow.Cells("modificado_por").Value
        txtcrea.Text = dgvproucto.CurrentRow.Cells("creado_por").Value
