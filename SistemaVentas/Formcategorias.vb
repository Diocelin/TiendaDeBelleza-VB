Public Class Formcategorias
    ...
    Private Sub btnguardar_Click(sender As Object, e As EventArgs) Handles btnguardar.Click
        ...
        If (txtCategoria.Text <> String.Empty) Then
            ...
            If (txtcodigocat.Text <> String.Empty) Then
                If (c.edita_categoria(txtcodigocat.Text, txtCategoria.Text, txtmodifica.Text, txtcrea.Text, txtestado.Text, txtproveedor.Text) = True) Then
                ...
                End If
            Else
                If (c.ingresa_categoria(txtcodigocat.Text, txtCategoria.Text, txtmodifica.Text, txtcrea.Text, txtestado.Text, txtproveedor.Text) = True) Then
    ...
    Private Sub dgvcategoria_DoubleClick(sender As Object, e As EventArgs) Handles dgvcategoria.DoubleClick
        ...
        txtCategoria.Text = dgvcategoria.CurrentRow.Cells("proveedor").Value
        btnguardar.Enabled = False
