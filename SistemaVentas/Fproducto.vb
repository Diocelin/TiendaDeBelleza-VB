...
Public Class Fproducto
    ...
    Public Function ingresa_producto(cod As String, nom As String, est As String, cre As String, modi As String, prec As Decimal, stock As Int16, codcat As String) As Boolean
        conectado()
    ...
    Public Function edita_producto(cod As String, nom As String, est As String, cre As String, modi As String, prec As Decimal, stock As Int16, codcat As String) As Boolean
        conectado()
