...
Public Class Fcliente
    ...
    Public Function ingresa_cliente(cod As String, nom As String, ape As String, cre As String, est As String, modi As String, dir As String, tel As String) As Boolean
        conectado()
    ...
    Public Function edita_cliente(cod As String, nom As String, est As String, ape As String, cre As String, modi As String, dir As String, tel As String) As Boolean
        conectado()
